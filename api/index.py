"""
Agriculture Disease Finder — FastAPI Vercel Serverless Function
=============================================================
Serving crop disease predictions from crop-specific Bayesian Networks.
All routes are prefixed with /api to integrate with Vercel routing rules.
"""
    ...
    "corn": {
        ...
        "disease_info": {
            ...
            "Common_Rust": {
                ...
                "chemical": [
                    "Apply strobulin or triazole foliar fungicides if rust appears prior to tasseling"
                ],
                "prevention": [
